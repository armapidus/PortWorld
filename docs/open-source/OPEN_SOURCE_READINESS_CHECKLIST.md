...
- [x] Choose and add a real root `LICENSE` file.
...
- [x] Add a root `SECURITY.md` with disclosure instructions.
...
- [x] Decide whether the repo is safe for public issue reports or needs “do not post secrets/logs” guidance.

## 7. Community And Contribution Hygiene

- [x] Add `CONTRIBUTING.md`.
- [x] Add `CODE_OF_CONDUCT.md`.
- [x] Decide how you want to handle:
  - support questions
  - bug reports
  - feature requests
  - outside pull requests
- [x] Add issue and PR templates if you want structured inbound contributions.
- [x] State repo expectations clearly:
  - supported branches
  - review bar
...
- [x] Add a changelog or release-notes convention.
- [x] Decide whether package/distribution channels are:
  - source-only
  - GitHub releases
  - package registry
  - installer script
- [x] Ensure docs and installer/update instructions point at a real release strategy, not just current maintainer workflow.

## 9. Repo Cleanup

- [ ] Remove dead code, abandoned experiments, and misleading placeholders that make the repo look less trustworthy.
- [x] Archive or relocate historical docs if they are useful for maintainers but confusing for new users.
- [x] Remove generated artifacts and editor/system junk from the tracked tree.
