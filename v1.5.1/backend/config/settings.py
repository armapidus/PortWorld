...
def load_settings() -> AppSettings:
    ...
    return AppSettings(
        app_name=os.getenv("APP_NAME", "hackathon-multimodal-api").strip(),
        ...
        default_main_llm_system_prompt=os.getenv("MAIN_LLM_SYSTEM_PROMPT", "Tu es un assistant utile et concis.").strip(),
        ...
        default_vision_system_prompt=os.getenv("VISION_SYSTEM_PROMPT", "Tu es un modele de securite pour un assistant vocal.").strip(),
