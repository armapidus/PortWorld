...
from backend.infrastructure.storage.common.record_mappers import (
    to_artifact_record,
    to_vision_frame_index_record,
)
...
class PostgresMetadataStore:
    ...
    def list_artifact_records_for_session(self, *, session_id: str) -> list[ArtifactRecord]:
        ...
        return [to_artifact_record(dict(row)) for row in rows]
    ...
    def get_vision_frame_record(
        ...
        *,
        ...
        if row is None:
            return None
        return to_vision_frame_index_record(dict(row))
    ...
    def list_recent_vision_frame_records(
        ...
        *,
        ...
        return [to_vision_frame_index_record(dict(row)) for row in rows]
